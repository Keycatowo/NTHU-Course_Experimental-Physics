...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
     set(handles.x1,'string','-50');
     set(handles.y1,'string','0');
     set(handles.z1,'string','3');
     set(handles.vx1,'string','0');
     set(handles.vy1,'string','18.5');
     set(handles.m1,'string','1000');
     
     set(handles.x2,'string','50');
     set(handles.y2,'string','0');
     set(handles.z2,'string','3');
     set(handles.vx2,'string','0');
     set(handles.vy2,'string','-18.5');
     set(handles.m2,'string','1000');
    
     
     set(handles.x3,'string','0');
     set(handles.y3,'string','0');
     set(handles.z3,'string','5');
     set(handles.vx3,'string','0');
     set(handles.vy3,'string','0');
     set(handles.m3,'string','1000');
     
     set(handles.Xmin,'string','-150');
     set(handles.Xmax,'string',' 150');
     set(handles.Ymin,'string','-150');
     set(handles.Ymax,'string',' 150');
